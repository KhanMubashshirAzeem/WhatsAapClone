...
//                                                                        holder.lastMessage.setText(snapshot1.child("message").getValue().toString());           // Same below
                                                                        holder.lastMessage.setText(snapshot1.child("message").getValue(String.class));      // same above
                                                                    }
                                                                }
                                                            }
                                                            @Override
